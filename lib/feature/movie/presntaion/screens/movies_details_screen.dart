...
import 'package:seconde_project_clean_architecture/core/utiles/recommendation_model.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<DetailsMoviesBloc>()
        ..add(GetMoviesDetailsEvents(id))
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.moviesDetails!.realeseDate
                                      .split('-')[0],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.moviesDetails!.voteAvareg / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  const SizedBox(width: 4.0),
                                  Text(
                                    '(${state.moviesDetails!.voteAvareg})',
                                    style: const TextStyle(
                                      fontSize: 1.0,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: 1.2,
